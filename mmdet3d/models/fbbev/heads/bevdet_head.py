...
from mmdet3d.utils import normalize_bbox
from mmcv.runner import force_fp32, auto_fp16


@HEADS.register_module(force=True)
class BEVHead(DETRHead):
    """Head of Detr3D.
    Args:
    ...
    def _init_layers(self):
        ...
        if not self.as_two_stage:
            ...
            self.query_embedding = nn.Embedding(self.num_query,
                                                self.embed_dims * 2)
        self.bev_embed_fc = nn.Linear(self.embed_dims // 2, self.embed_dims)
    ...
    def forward(self, bev_embed, img_metas, prev_bev=None):
        ...
        bs, dim, w, h = bev_embed.shape
        bev_embed = bev_embed.reshape(bs, w*h, dim) # [B, N, 128]
        bev_embed = self.bev_embed_fc(bev_embed) # [B, N, 256]
